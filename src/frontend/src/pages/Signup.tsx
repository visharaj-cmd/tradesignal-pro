    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-heading-1 text-3xl">Create Account</h1>
          <p className="text-muted-foreground text-sm mt-2">
            Start trading with professional signals for just ₹1/day
          </p>
        </div>
        ...
        <div className="card-elevated rounded-2xl p-8 border border-border/60">
          <div className="mb-6">
            <h2 className="text-heading-2 text-xl mb-1">Get started free</h2>
            <p className="text-sm text-muted-foreground">
              Sign up to access professional trading signals
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              {errors.password && touched.password && !showRules && (
                <p className="text-xs text-destructive">{errors.password}</p>
              )}
              {showRules && (
                <ul className="mt-2 space-y-1 pl-1 bg-muted/20 rounded-lg p-3">
                  <PasswordRule
                    met={rules.length}
        ...
        <div className="mt-5 flex items-center justify-center gap-2 text-xs text-muted-foreground">
          ...
          <span>256-bit secured · TradeSignal Pro</span>
        </div>
      </div>
    </div>
  );
